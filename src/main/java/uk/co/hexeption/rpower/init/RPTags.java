...
public class RPTags {
    ...
    public static final TagKey<Block> MINEABLE_WITH_SICKLE = TagKey.create(BuiltInRegistries.BLOCK.key(), ResourceLocation.fromNamespaceAndPath(Rpower.MODID, "mineable_with_sickle"));
